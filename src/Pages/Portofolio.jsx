...
import { PROJECTS_DATA, CERTIFICATES_DATA } from "../data";
...
export default function FullWidthTabs() {
  ...
  const [projects, setProjectsnew] = useState(PROJECTS_DATA);
  const [certificates, setCertificatesnew] = useState(CERTIFICATES_DATA);
