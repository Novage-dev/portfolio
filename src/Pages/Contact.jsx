...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // FORCE mailto to open (fixes Windows/Chrome issue)
      const a = document.createElement("a");
      a.href = `mailto:issacharjobz@gmail.com?subject=${subject}&body=${body}`;
      ...
      Swal.fire({
        ...
        text: "Please press SEND inside your mail app.",
        icon: "success",
  ...
  return (
    <>
      ...
      <div
        ...
        id="Contact"
      >
        <div className="container px-[1%] flex justify-center mx-auto">
          <div
            data-aos="fade-right"
